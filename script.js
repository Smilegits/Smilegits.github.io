...
(function () {
  ...
  /* ---- Contact form: async submit → serverless API (Mongo + auto-reply email) ---- */
  ...
  if (form) {
    ...
    form.addEventListener("submit", async function (e) {
      ...
      if (data._gotcha) return; // honeypot tripped — silently ignore bots
      ...
      if (endpoint.indexOf("YOUR-VERCEL-APP") !== -1) {
        setStatus("error", "The form backend isn't connected yet. Meanwhile, email me at <strong>smileshelley270702@gmail.com</strong>.");
      ...
      try {
        ...
        setStatus("success",
          "Thanks, <strong>" + (data.name || "there") + "</strong>! 🎉 A confirmation email with your details is on its way to <strong>" +
          data.email + "</strong>. Smile will get to know about you and reply soon.");
        form.reset();
